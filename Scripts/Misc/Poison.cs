    ...
    public class PoisonImpl : Poison
    {
        ...
        public static void Configure()
        {
            ...
            else
            {
                ...
                Register(new PoisonImpl("Deadly", 3, 10, 26, 16.500, 3.5, 4.2, 10, 2));
                Register(new PoisonImpl("Lethal", 4, 12, 26, 20.000, 3.5, 5.0, 10, 2));
            }
        ...
        public class PoisonTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                if (m_From != null && m_From.Player && m_Mobile != null && !m_Mobile.Player)
                {
                    ...
                    if (ElementoPvM.Terra.ForteContra(m_Mobile.Elemento))
                    {
                        bonus *= 2;
                    }
                    damage += bonus;
