...
namespace Server.Spells.Fourth
{
    public class RecallSpell : MagerySpell
    {
        ...
        public override bool CheckCast()
        {
            ...
            else if (SpellHelper.CheckCombatFast(Caster))
            {
            ...
            {
                Caster.SendMessage("Voce esta muito pesado para conseguir usar Recall"); // Thou art too encumbered to move.
                return false;
            }
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(RecallSpell owner)
                : base(Spell.RANGE / 2, true, TargetFlags.None)
            {
                m_Owner = owner;
