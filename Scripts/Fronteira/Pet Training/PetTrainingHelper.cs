...
namespace Server.Mobiles
{
    ...
    {
        public static bool Enabled { get { return true; } }//return Core.TOL; } }
        ...
        public static void LoadDefinitions()
        {
            ...
            Definitions = new TrainingDefinition[]
            {
                ...
                new TrainingDefinition(typeof(YoungDragon), Class.MagicalClawedAndTailed, MagicalAbility.Dragon2, SpecialAbilityNone, WepAbility2, AreaEffectArea1, 3, 4),
        ...
        public static void OnWeaponAbilityUsed(BaseCreature bc, SkillName skill)
        {
            if (Enabled && bc.Controlled)
            {
                ...
                if (profile != null/* && profile.TokunoTame*/)
                {
                    bc.CheckSkillMult(skill, 0.0, bc.Skills[skill].Cap);
                }
            }
        }
        #endregion
