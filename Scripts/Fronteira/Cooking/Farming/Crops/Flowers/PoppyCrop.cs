...
{
	public class PoppySeed : HerdingBaseCrop
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			this.Consume();
			Item item = new PoppySeedling( from );
			item.Location = m_pnt;
			item.Map = m_map;
		}
	...
	public class PoppySeedling : HerdingBaseCrop
	{
		...
		public static void init( PoppySeedling plant )
		{
			plant.thisTimer = new CropHelper.GrowTimer( plant, typeof(PoppyCrop), plant.Sower );
	...
	public class PoppyCrop : HerdingBaseCrop
	{
		...
		public static void init ( PoppyCrop plant, bool full )
		{
		...
		{
			private PoppyCrop i_plant;
			public CropTimer( PoppyCrop plant ) : base( TimeSpan.FromSeconds( 450 ), TimeSpan.FromSeconds( 15 ) )
			{
