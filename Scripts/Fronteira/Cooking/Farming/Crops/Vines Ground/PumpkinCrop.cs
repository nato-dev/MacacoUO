...
{
	public class PumpkinSeed : HerdingBaseCrop
	{
	...
	public class PumpkinSeedling : HerdingBaseCrop
	{
	...
	public class PumpkinCrop : HerdingBaseCrop
	{
		...
		{
			private PumpkinCrop i_plant;
			public CropTimer( PumpkinCrop plant ) : base( TimeSpan.FromSeconds( 450 ), TimeSpan.FromSeconds( 15 ) )
			{
