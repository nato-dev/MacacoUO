...
{
	public class LettuceSeed : HerdingBaseCrop
	{
	...
	public class LettuceSeedling : HerdingBaseCrop
	{
	...
	public class LettuceCrop : HerdingBaseCrop
	{
		...
		private class CropTimer : Timer
		{
			...
			public CropTimer( LettuceCrop plant ) : base( TimeSpan.FromSeconds( 450 ), TimeSpan.FromSeconds( 15 ) )
			{
