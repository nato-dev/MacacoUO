...
{
	public class StrawberrySeed : HerdingBaseCrop
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			this.Consume();
			Item item = new StrawberrySeedling( from );
			item.Location = m_pnt;
			item.Map = m_map;
		}
	...
	public class StrawberrySeedling : HerdingBaseCrop
	{
		...
		public static void init( StrawberrySeedling plant )
		{
			plant.thisTimer = new CropHelper.GrowTimer( plant, typeof(StrawberryCrop), plant.Sower );
	...
	public class StrawberryCrop : HerdingBaseCrop
	{
		...
		public static void init ( StrawberryCrop plant, bool full )
		{
			plant.PickGraphic = ( Utility.RandomList ( 0x1A99, 0x1A9A ) );
		...
		{
			private StrawberryCrop i_plant;
			public CropTimer( StrawberryCrop plant ) : base( TimeSpan.FromSeconds( 450 ), TimeSpan.FromSeconds( 15 ) )
			{
