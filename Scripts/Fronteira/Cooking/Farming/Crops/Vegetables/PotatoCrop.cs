...
{
	public class PotatoSeed : HerdingBaseCrop
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			this.Consume();
			Item item = new PotatoSeedling( from );
			item.Location = m_pnt;
			item.Map = m_map;
		}
	...
	public class PotatoSeedling : HerdingBaseCrop
	{
		...
		public static void init( PotatoSeedling plant )
		{
			plant.thisTimer = new CropHelper.GrowTimer( plant, typeof(PotatoCrop), plant.Sower );
	...
	public class PotatoCrop : HerdingBaseCrop
	{
		...
		public static void init ( PotatoCrop plant, bool full )
		{
		...
		{
			private PotatoCrop i_plant;
			public CropTimer( PotatoCrop plant ) : base( TimeSpan.FromSeconds( 450 ), TimeSpan.FromSeconds( 15 ) )
			{
