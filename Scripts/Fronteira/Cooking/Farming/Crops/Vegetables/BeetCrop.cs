...
{
	public class BeetSeed : HerdingBaseCrop
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			this.Consume();
			Item item = new BeetSeedling( from );
			item.Location = m_pnt;
			item.Map = m_map;
		}
	...
	public class BeetSeedling : HerdingBaseCrop
	{
		...
		public static void init( BeetSeedling plant )
		{
			plant.thisTimer = new CropHelper.GrowTimer( plant, typeof(BeetCrop), plant.Sower );
	...
	public class BeetCrop : HerdingBaseCrop
	{
		...
		public static void init ( BeetCrop plant, bool full )
		{
			plant.PickGraphic = ( 0xC6F );
		...
		{
			private BeetCrop i_plant;
			public CropTimer( BeetCrop plant ) : base( TimeSpan.FromSeconds( 450 ), TimeSpan.FromSeconds( 15 ) )
			{
