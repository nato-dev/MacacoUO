...
{
	public class PeanutSeed : HerdingBaseCrop
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			this.Consume();
			Item item = new PeanutSeedling( from );
			item.Location = m_pnt;
			item.Map = m_map;
		}
	...
	public class PeanutSeedling : HerdingBaseCrop
	{
		...
		public static void init( PeanutSeedling plant )
		{
			plant.thisTimer = new CropHelper.GrowTimer( plant, typeof(PeanutCrop), plant.Sower );
	...
	public class PeanutCrop : HerdingBaseCrop
	{
		...
		public static void init ( PeanutCrop plant, bool full )
		{
		...
		{
			private PeanutCrop i_plant;
			public CropTimer( PeanutCrop plant ) : base( TimeSpan.FromSeconds( 450 ), TimeSpan.FromSeconds( 15 ) )
			{
