...
{
	public class CarrotSeed : HerdingBaseCrop
	{
	...
	public class CarrotSeedling : HerdingBaseCrop
	{
	...
	public class CarrotCrop : HerdingBaseCrop
	{
		...
		private class CropTimer : Timer
		{
			...
			public CropTimer( CarrotCrop plant ) : base( TimeSpan.FromSeconds( 450 ), TimeSpan.FromSeconds( 15 ) )
			{
