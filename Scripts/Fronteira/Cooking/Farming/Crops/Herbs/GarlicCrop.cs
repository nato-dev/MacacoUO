...
{
	public class GarlicSeed : HerdingBaseCrop
	{
	...
	public class GarlicSeedling : HerdingBaseCrop
	{
	...
	public class GarlicCrop : HerdingBaseCrop
	{
		...
		private class CropTimer : Timer
		{
			...
			public CropTimer( GarlicCrop plant ) : base( TimeSpan.FromSeconds( 450 ), TimeSpan.FromSeconds( 15 ) )
			{
