...
{
	public class BlackRaspberrySeed : HerdingBaseCrop
	{
	...
	public class BlackRaspberrySeedling : BaseSeedling
	{
		...
		[Constructable]
		public BlackRaspberrySeedling( Mobile sower ) : base( sower, 0xC61 )
		{
			Movable = false;
        ...
        public override Type GetPlantType()
        {
            return typeof(BlackRaspberryCrop);
        }
    }

	public class BlackRaspberryCrop : HerdingBaseCrop
	{
