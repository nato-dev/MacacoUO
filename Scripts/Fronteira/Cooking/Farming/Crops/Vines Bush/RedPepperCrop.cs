...
{
	public class RedPepperSeed : HerdingBaseCrop
	{
		public override bool CanGrowGarden{ get{ return true; } }

		[Constructable]
		public RedPepperSeed() : this( 1 ) { }

		[Constructable]
		public RedPepperSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true;
			Weight = .1;
			Hue = 0x5E2;
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			this.Consume();
			Item item = new RedPepperSeedling( from );
			item.Location = m_pnt;
			item.Map = m_map;
		}

		public RedPepperSeed( Serial serial ) : base( serial ) { }
	...
	public class RedPepperSeedling : HerdingBaseCrop
	{
		...
		[Constructable]
		public RedPepperSeedling( Mobile sower ) : base( 0xC61 )
		{
			Movable = false;
			Name = "Red Pepper Seedling";
			m_sower = sower;
			init( this );
		}
		public static void init( RedPepperSeedling plant )
		{
			plant.thisTimer = new CropHelper.GrowTimer( plant, typeof(RedPepperCrop), plant.Sower );
		...
		public RedPepperSeedling( Serial serial ) : base( serial ) { }
	...
	public class RedPepperCrop : HerdingBaseCrop
	{
		...
		[Constructable]
		public RedPepperCrop() : this(null) { }

		[Constructable]
		public RedPepperCrop( Mobile sower ) : base( 3213 )
		{
			Movable = false;
			Name = "Red Pepper Plant";
			Hue = 2986;
			m_sower = sower;
		...
		public static void init ( RedPepperCrop plant, bool full )
		{
			...
			if ( DateTime.UtcNow > lastpicked.AddSeconds(3) )
			{
				...
				if ( from.InRange( this.GetWorldLocation(), 1 ) )
				{
					...
					else
					{
						...
						RedPepper crop = new RedPepper( pick );
		...
		{
			private RedPepperCrop i_plant;
			public CropTimer( RedPepperCrop plant ) : base( TimeSpan.FromSeconds( 450 ), TimeSpan.FromSeconds( 15 ) )
			{
		...
		public RedPepperCrop( Serial serial ) : base( serial ) { }
