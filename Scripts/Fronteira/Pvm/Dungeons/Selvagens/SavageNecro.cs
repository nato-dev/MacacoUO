...
namespace Server.Mobiles
{
	...
	public class SavageNecro : BaseCreature
	{
		[Constructable]
		public SavageNecro()
			: base(AIType.AI_NecroMage, FightMode.Closest, 10, 1, 0.2, 0.4)
		{
			...
			SetSkill(SkillName.Necromancy, 72.5, 95.0);
            SetSkill(SkillName.Magery, 32.5, 50.0);
            ...
            {
                arma.Resource = CraftResource.Carvalho;
            }
        ...
        public override bool OnBeforeDeath()
        {
            ...
            {
                var mask = this.FindItemByType<DeerMask>();
                if (mask != null)
