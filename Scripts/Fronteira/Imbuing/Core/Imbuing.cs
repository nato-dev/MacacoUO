    ...
    public class Imbuing
    {
        ...
        public static TimeSpan OnUse(Mobile from)
        {
            ...
            else
            {
                ...
                {
                    from.Target = new DerreteTarget();
                    from.SendMessage("Escolha uma arma ou armadura magica para desfazer.");
                }
            }
            return TimeSpan.FromSeconds(1.0);
        }

        private class DerreteTarget : Target
        {
            public DerreteTarget() : base(12, false, TargetFlags.None)
            {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                {
                    from.SendMessage("Use derreta uma arma ou armadura magica.");
                }
        ...
        public static bool CanImbueItem(Mobile from, Item item)
        {
            ...
            else if (item.LootType == LootType.Blessed || item.LootType == LootType.Blessed)
            {
        ...
        private static Type[] _SpecialImbuable =
       {
        ...
        public static double GetSuccessChance(Mobile from, Item item, int totalItemWeight, int propWeight, out double dif)
        {
            ...
            if (suc > 100 && from.AccessLevel <= AccessLevel.VIP) //display purposes
                suc = 100;
        ...
        public static void TryImbueItem(Mobile from, Item i, int mod, int value)
        {
            ...
            var gemAmount = GetGemAmount(i, mod, value);
            var primResAmount = GetPrimaryAmount(i, mod, value);
            var specResAmount = GetSpecialAmount(i, mod, value);
            ...
            else
            {
                ...
                var totalItemWeight = GetTotalWeight(i, mod);
                var totalItemMods = GetTotalMods(i, mod);
                var maxint = GetMaxIntensity(i, def);
                ...
                if (TimesImbued(i) < 20)
                {
                    from.CheckSkillMult(SkillName.Imbuing, difficulty - 50, difficulty + 50);
                }
        ...
        public static bool UnravelItem(Mobile from, Item item, bool message = true)
        {
            ...
            if (weight >= 480 - bonus)
            {
                ...
                if (from.CheckSkillMult(SkillName.Imbuing, 90.1, 120.0))
                {
                    success = true;
                    resType = typeof(RelicFragment);
                    resAmount = 1;
                }
                else if (from.CheckSkillMult(SkillName.Imbuing, 45.0, 95.0))
                {
                    success = true;
            ...
            else if (weight > 200 - bonus && weight < 480 - bonus)
            {
                ...
                if (from.CheckSkillMult(SkillName.Imbuing, 45.0, 95.0))
                {
                    success = true;
                    resType = typeof(EnchantedEssence);
                    resAmount = Math.Max(1, resAmount);
                }
                else if (from.CheckSkillMult(SkillName.Imbuing, 0.0, 45.0))
                {
                    success = true;
            ...
            {
                if (from.CheckSkillMult(SkillName.Imbuing, 0.0, 45.0))
                {
                    success = true;
                    resType = typeof(MagicalResidue);
                    resAmount = Math.Max(1, resAmount + Utility.Random(2));
        ...
        static Imbuing()
        {
            ...
            m_Table[102] = new ImbuingDefinition(SlayerName.Trolls, 1079754, 100, typeof(MagicalResidue), typeof(Emerald), typeof(WhitePearl), 1, 0, 1111990, true, true);
            m_Table[103] = new ImbuingDefinition(SlayerName.Ogros, 1079739, 100, typeof(MagicalResidue), typeof(Emerald), typeof(WhitePearl), 1, 0, 1111975, true, true);
            m_Table[104] = new ImbuingDefinition(SlayerName.Dragoes, 1061284, 100, typeof(MagicalResidue), typeof(Emerald), typeof(WhitePearl), 1, 0, 1111970, true, true);
            ...
            m_Table[106] = new ImbuingDefinition(SlayerName.Cobras, 1079744, 100, typeof(MagicalResidue), typeof(Emerald), typeof(WhitePearl), 1, 0, 1111980, true, true);
            m_Table[107] = new ImbuingDefinition(SlayerName.HomensLagarto, 1079738, 100, typeof(MagicalResidue), typeof(Emerald), typeof(WhitePearl), 1, 0, 1111974, true, true);
            ...
            m_Table[108] = new ImbuingDefinition(SlayerName.Gargulas, 1079737, 100, typeof(MagicalResidue), typeof(Emerald), typeof(WhitePearl), 1, 0, 1111973, true, true);
            ...
            m_Table[111] = new ImbuingDefinition(SlayerName.Ofidianos, 1079740, 100, typeof(MagicalResidue), typeof(Emerald), typeof(WhitePearl), 1, 0, 1111976, true, true);
            m_Table[112] = new ImbuingDefinition(SlayerName.Aranhas, 1079746, 100, typeof(MagicalResidue), typeof(Emerald), typeof(WhitePearl), 1, 0, 1111982, true, true);
            m_Table[113] = new ImbuingDefinition(SlayerName.Escorpioes, 1079743, 100, typeof(MagicalResidue), typeof(Emerald), typeof(WhitePearl), 1, 0, 1111979, true, true);
            m_Table[114] = new ImbuingDefinition(SlayerName.Flamejantes, 1079736, 100, typeof(MagicalResidue), typeof(Emerald), typeof(WhitePearl), 1, 0, 1111972, true, true);
            m_Table[115] = new ImbuingDefinition(SlayerName.Aquosos, 1079755, 100, typeof(MagicalResidue), typeof(Emerald), typeof(WhitePearl), 1, 0, 1111991, true, true);
            ...
            m_Table[117] = new ImbuingDefinition(SlayerName.Envenenados, 1079742, 100, typeof(MagicalResidue), typeof(Emerald), typeof(WhitePearl), 1, 0, 1111978, true, true);
            m_Table[118] = new ImbuingDefinition(SlayerName.QuedraPedras, 1079735, 100, typeof(MagicalResidue), typeof(Emerald), typeof(WhitePearl), 1, 0, 1111971, true, true);
            m_Table[119] = new ImbuingDefinition(SlayerName.Sanguinarios, 1079734, 100, typeof(MagicalResidue), typeof(Emerald), typeof(WhitePearl), 1, 0, 1111969, true, true);
            m_Table[120] = new ImbuingDefinition(SlayerName.Gelados, 1079745, 100, typeof(MagicalResidue), typeof(Emerald), typeof(WhitePearl), 1, 0, 1111981, true, true);

            //Super Slayers
            m_Table[121] = new ImbuingDefinition(SlayerName.Undeads, 1079752, 130, typeof(RelicFragment), typeof(Ruby), typeof(UndyingFlesh), 1, 0, 1111988, true, true);
            m_Table[122] = new ImbuingDefinition(SlayerName.Humanoides, 1079750, 130, typeof(RelicFragment), typeof(Ruby), typeof(GoblinBlood), 1, 0, 1111986, true, true);
            m_Table[123] = new ImbuingDefinition(SlayerName.Repteis, 1079751, 130, typeof(RelicFragment), typeof(Ruby), typeof(LavaSerpentCrust), 1, 0, 1111987, true, true);
            m_Table[124] = new ImbuingDefinition(SlayerName.Exorcismo, 1079748, 130, typeof(RelicFragment), typeof(Ruby), typeof(DaemonClaw), 1, 0, 1111984, true, true);
            m_Table[125] = new ImbuingDefinition(SlayerName.Aracnideos, 1079747, 130, typeof(RelicFragment), typeof(Ruby), typeof(SpiderCarapace), 1, 0, 1111983, true, true);
            m_Table[126] = new ImbuingDefinition(SlayerName.Elemental, 1079749, 130, typeof(RelicFragment), typeof(Ruby), typeof(VialOfVitriol), 1, 0, 1111985, true, true);
            m_Table[127] = new ImbuingDefinition(SlayerName.Fadas, 1154652, 130, typeof(RelicFragment), typeof(Ruby), typeof(FeyWings), 1, 0, 1154652, true, true);

            m_Table[128] = new ImbuingDefinition(SlayerName.Dinossauros, 1156240, 130, null, null, null, 1, 0, -1, true, true);
