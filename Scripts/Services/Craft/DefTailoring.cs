...
namespace Server.Engines.Craft
{
    ...
    public class DefTailoring : CraftSystem
    {
        ...
        public override void PlayCraftEffect(Mobile from)
        {
            ...
            from.Animate(AnimationType.Block, 0);
        }
        ...
        public override void InitCraftList()
        {
            ...
            index = AddCraft(typeof(EnhancedBandage), 1015283, "Bandagem Medica +10 Healing", 20, 120, typeof(Cloth), 1044455, 50, 1044287);
            AddRes(index, typeof(Charcoal), "Carvao", 1, "Voce precisa de carvao para fazer isto");
            AddRes(index, typeof(Ginseng), "Ginseng", 30, "Voce precisa de ginseng para fazer isto");
            AddRes(index, typeof(MandrakeRoot), "Mandrake Root", 30, "Voce precisa de mandrake root para fazer isto");
            ...
            index = AddCraft(typeof(ElvenBoots), 1015288, 1072902, 50.0, 80.0, typeof(Leather), 1044462, 8, 1044463);
            AddRes(index, typeof(HoneyComb), "Favo de Mel", 5, "Voce nao tem os recursos necessarios");
            #endregion
