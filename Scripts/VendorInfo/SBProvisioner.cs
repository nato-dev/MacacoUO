    ...
    public class SBProvisioner : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            public InternalBuyInfo()
            {
                ...
                Add(new GenericBuyInfo(typeof(Arrow), 4, 500, 0xF3F, 0, true));
                Add(new GenericBuyInfo(typeof(Bolt), 6, 500, 0x1BFB, 0, true));

                Add(new GenericBuyInfo(typeof(Backpack), 15, 20, 0x9B2, 0));
                Add(new GenericBuyInfo(typeof(Pouch), 6, 20, 0xE79, 0));
                Add(new GenericBuyInfo(typeof(TrappedPouch), 100, 100, 0xE79, 38));
