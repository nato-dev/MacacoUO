...
namespace Server.Mobiles
{
    ...
    public class PetTrainingConfirmGump : BaseGump
    {
        ...
        public override void AddGumpLayout()
        {
            ...
            AddButton(70, 150, 5601, 5601, 1, GumpButtonType.Reply, 0);
            AddHtml(70, 153, 126, 16, Center("Sim"), false, false);

            AddECHandleInput();
            AddECHandleInput();

            AddButton(235, 150, 5601, 5601, 2, GumpButtonType.Reply, 0);
            AddHtml(235, 153, 126, 16, Center("Cancelar"), false, false);
    ...
    public class PetTrainingOptionsGump : BaseGump
    {
        ...
        public override void AddGumpLayout()
        {
            ...
            AddButton(35, 490, 5601, 5601, 0, GumpButtonType.Reply, 0);
            AddHtml(35, 493, 126, 20, Center("CANCELAR"), false, false);

            AddECHandleInput();
            AddECHandleInput();

            AddButton(220, 490, 5601, 5601, 1, GumpButtonType.Reply, 0);
            AddHtml(220, 493, 126, 20, Center("PLANO"), false, false);

            AddECHandleInput();
            AddECHandleInput();

            AddButton(410, 490, 5601, 5601, 2, GumpButtonType.Reply, 0);
    ...
    public class PetTrainingConfirmationGump : BaseGump
    {
        ...
        public override void AddGumpLayout()
        {
            ...
            AddButton(40, 410, 5601, 5601, 1, GumpButtonType.Reply, 0);
            AddHtml(40, 413, 126, 20, Center("Back"), false, false);

            AddButton(415, 410, 5601, 5601, profile.TrainingMode == TrainingMode.Regular ? 8 : 9, GumpButtonType.Reply, 0);
            AddHtml(415, 413, 126, 20, Center(profile.TrainingMode == TrainingMode.Regular ? "Treinar" : "Planejar"), false, false);
    ...
    public class PetTrainingPlanningGump : BaseGump
    {
        ...
        public override void AddGumpLayout()
        {
            ...
            for (int i = 0; i < plan.Entries.Count; i++)
            {
                ...
                if (loc[0].Number > 0)
                    AddHtml(260, y, 200, 18, loc[0], false, false);
                else if (loc[0].String != null)
    ...
    public class PetTrainingInfoGump : BaseGump
    {
        ...
        public override void AddGumpLayout()
        {
            ...
            AddHtmlLocalized(0, 45, 654, 16, CenterLoc, "Descobrir Treinos", 0xF424E5, false, false); // Discovering Animal Training
