...
namespace Server
{
    ...
    public class SkillInfo
    {
        ...
        private static SkillInfo[] m_Table = new SkillInfo[58]
        {
            ...
            new SkillInfo(16, "Evaluating Intelligence", 0.0, 0.0, 0.0, "Sabio", null, 0.0, 0.0, 1.0, COMBAT, StatCode.Int, StatCode.Str),
            new SkillInfo(17, "Healing", 6.0, 6.0, 8.0, "Curandeiro", null, 0.6, 0.6, 0.8, COMBAT, StatCode.Int, StatCode.Dex),
            new SkillInfo(18, "Fishing", 0.0, 0.0, 0.0, "Pescador", null, 0.5, 0.5, 0.0, HARD, StatCode.Dex, StatCode.Str),
            ...
            new SkillInfo(21, "Hiding", 0.0, 0.0, 0.0, "Gatuno", null, 0.0, 0.8, 0.2, COMBAT, StatCode.Dex, StatCode.Int),
            ...
            new SkillInfo(33, "Stealing", 0.0, 10.0, 0.0, "Ladino", null, 0.0, 1.0, 0.0, MEDIUM, StatCode.Dex, StatCode.Int),
