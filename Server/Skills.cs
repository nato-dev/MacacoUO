...
namespace Server
{
    ...
    public class Skill
    {
        ...
        public Skill(Skills owner, SkillInfo info, GenericReader reader)
        {
            ...
            //Console.WriteLine("----- SKILL VERSION: " + version);

            switch (version)
            {
                case 0:
                    {
                        m_Exp = reader.ReadUShort();
    ...
    public class SkillInfo
    {
        ...
        private static SkillInfo[] m_Table = new SkillInfo[58]
        {
            ...
            new SkillInfo(1, "Anatomy", 0.0, 0.0, 0.0, "Biologo", null, 0.15, 0.15, 0.7, EASY, StatCode.Int, StatCode.Str),
            ...
            new SkillInfo(4, "Arms Lore", 0.0, 0.0, 0.0, "Armeiro", null, 0.75, 0.15, 0.1, EASY, StatCode.Int, StatCode.Str),
            ...
            new SkillInfo(8, "Bowcraft/Fletching", 6.0, 16.0, 0.0, "Criador de Arcos", null, 0.6, 1.6, 0.0, HARD, StatCode.Dex, StatCode.Str),
            new SkillInfo(9, "Peacemaking", 0.0, 0.0, 0.0, "Pacificador", null, 0.0, 0.0, 0.0, COMBAT, StatCode.Int, StatCode.Dex, true ),
            new SkillInfo(10, "Camping", 20.0, 15.0, 15.0, "Explorador", null, 2.0, 1.5, 1.5, EASY, StatCode.Dex, StatCode.Int),
            new SkillInfo(11, "Carpentry", 20.0, 5.0, 0.0, "Carpinteiro", null, 2.0, 0.5, 0.0, HARD, StatCode.Str, StatCode.Dex),
            new SkillInfo(12, "Cartography", 0.0, 7.5, 7.5, "Cartografo", null, 0.0, 0.75, EASY, 0.4, StatCode.Int, StatCode.Dex),
            new SkillInfo(13, "Cooking", 0.0, 20.0, 30.0, "Chef", null, 0.0, 2.0, 3.0, HARD, StatCode.Int, StatCode.Dex),
            new SkillInfo(14, "Detecting Hidden", 0.0, 0.0, 0.0, "Escouta", null, 0.0, 0.4, 0.6, COMBAT, StatCode.Int, StatCode.Dex),
            new SkillInfo(15, "Discordance", 0.0, 2.5, 2.5, "Desmoralizador", null, 0.0, 0.25, 0.25, COMBAT, StatCode.Dex, StatCode.Int, true ),
            new SkillInfo(16, "Evaluating Intelligence", 0.0, 0.0, 0.0, "Sabio", null, 0.0, 0.0, 1.0, EASY, StatCode.Int, StatCode.Str),
            new SkillInfo(17, "Healing", 6.0, 6.0, 8.0, "Curandeiro", null, 0.6, 0.6, 0.8, COMBAT, StatCode.Int, StatCode.Dex),
            new SkillInfo(18, "Fishing", 0.0, 0.0, 0.0, "Pescador", null, 0.5, 0.5, 0.0, MEDIUM, StatCode.Dex, StatCode.Str),
            new SkillInfo(19, "Forensic Evaluation", 0.0, 0.0, 0.0, "Detective", null, 0.0, 0.2, 0.8, EASY, StatCode.Int, StatCode.Dex),
            new SkillInfo(20, "Herding", 16.25, 6.25, 2.5, "Fazendeiro", null, 1.625, 0.625, 0.25, EASY, StatCode.Int, StatCode.Dex),
            ...
            new SkillInfo(29, "Musicianship", 0.0, 0.0, 0.0, "Bardo", null, 0.0, 0.8, 0.2, COMBAT, StatCode.Dex, StatCode.Int),
            new SkillInfo(30, "Poisoning", 0.0, 4.0, 16.0, "Assassino", null, 0.0, 0.4, 1.6, COMBAT, StatCode.Int, StatCode.Dex, true ),
            new SkillInfo(31, "Archery", 2.5, 7.5, 0.0, "Arqueiro", null, 0.25, 0.75, 0.0, COMBAT, StatCode.Dex, StatCode.Str, true ),
            new SkillInfo(32, "Spirit Speak", 0.0, 0.0, 0.0, "Medium", null, 0.0, 0.0, 1.0, COMBAT, StatCode.Int, StatCode.Str, false, true),
            ...
            new SkillInfo(42, "Fencing", 4.5, 5.5, 0.0, "Esgrimista", null, 0.45, 0.55, 0.0, COMBAT, StatCode.Dex, StatCode.Str, true ),
            new SkillInfo(43, "Wrestling", 9.0, 1.0, 0.0, "Boxer", null, 0.9, 0.1, 0.0, COMBAT, StatCode.Str, StatCode.Dex, true ),
            new SkillInfo(44, "Lumberjacking", 20.0, 0.0, 0.0, "Lenhador", null, 2.0, 0.0, 0.0, MEDIUM, StatCode.Str, StatCode.Dex),
            ...
            new SkillInfo(50, "Focus", 0.0, 0.0, 0.0, "Concentrador", null, 0.0, 0.0, 0.0, 0, StatCode.Dex, StatCode.Int),
            new SkillInfo(51, "Chivalry", 0.0, 0.0, 0.0, "Paladino", null, 1.0, 0.0, 1.0, COMBAT, StatCode.Str, StatCode.Int, true ),
            new SkillInfo(52, "Bushido", 0.0, 0.0, 0.0, "Samurai", null, 1.0, 1.0, 0.0, COMBAT, StatCode.Str, StatCode.Int, true ),
            new SkillInfo(53, "Ninjitsu", 0.0, 0.0, 0.0, "Ninja", null, 0.0, 2.0, 0.0, COMBAT, StatCode.Dex, StatCode.Int, true ),
            new SkillInfo(54, "Spellweaving", 0.0, 0.0, 0.0, "Arcanista", null, 0.0, 0.0, 2.0, COMBAT, StatCode.Int, StatCode.Str, true),
            new SkillInfo(55, "Mysticism", 0.0, 0.0, 0.0, "Mystico", null, 0.0, 0.0, 2.0, COMBAT, StatCode.Str, StatCode.Int, true ),
            new SkillInfo(56, "Imbuing", 0.0, 0.0, 0.0, "Artifice", null, 0.0, 0.0, 2.0, MEDIUM, StatCode.Int, StatCode.Str),
            new SkillInfo(57, "Throwing", 0.0, 0.0, 0.0, "Arremecador", null, 0.0, 2.0, 0.0, EASY, StatCode.Dex, StatCode.Str, true ),
        };
    ...
    public class Skills : IEnumerable<Skill>
    {
        ...
        [CommandProperty(AccessLevel.Counselor)]
        public Skill Fletching { get { return this[SkillName.Bowcraft]; } set { } }
            ...
            if (skillID >= 0 && skillID < SkillInfo.Table.Length)
            {
                ...
                if (info.Callback != null)
                {
                    if (Core.TickCount - from.NextSkillTime >= 0 && (info.UseWhileCasting || from.Spell == null))
                    {
                        ...
                        from.DisruptiveAction(info.SkillID != 46); // soh cancela medit se nao for a skill medit q ele usou
                        var t = info.Callback(from);
                        from.NextSkillTime = Core.TickCount + (int)t.TotalMilliseconds / 2;
                ...
                {
                    from.SendMessage("Esta skill nao e usada desta maneira"); // That skill cannot be used directly.
                }
            }
